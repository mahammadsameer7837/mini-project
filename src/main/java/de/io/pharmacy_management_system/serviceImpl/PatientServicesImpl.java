...
public class PatientServicesImpl implements PatientService {
	...
	private void validatePatient(Patient newPatient) throws NameCannotBeNullException, 
	InvalidNameException, InvalidAdmittedReason, AdmittedReasonCannotBeNullException, 
	InvalidDateOfDischarge, InvalidAddressException, AddressCannotBeNullException, InvalidDiseaseName, InvalidDoctorId, InvalidBillAmount {
	...
	public Patient updatePatient(int id, Patient modifiedPatient)
			...
			MedicineNotFoundException, InvalidNameException, NameCannotBeNullException, 
			InvalidDateOfDischarge, InvalidAddressException, AddressCannotBeNullException, 

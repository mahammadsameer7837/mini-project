...
public class PatientController {
	...
	public Patient addPatient(@RequestBody Patient patient) throws PatientsLimitReachedException, MedicineNotFoundException, DoctorNotFoundException, NameCannotBeNullException, InvalidNameException, InvalidAdmittedReason, AdmittedReasonCannotBeNullException, InvalidDateOfDischarge, InvalidAddressException, AddressCannotBeNullException, InvalidDiseaseName, InvalidDoctorId, InvalidBillAmount {
